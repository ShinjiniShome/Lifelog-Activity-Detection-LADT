...
THIS IS A COPY OF A PRIVATE REPOSITORY. CONTRIBUTIONS HAVE BEEN MADE BY THREE COLLABORATORS. (SARAH SAJID, TYSON PAIS, SHINJINI SHOME - Students of University of Koblenz)  
WE USE NTCIR-14 DATA TO RUN THE LIFELOG ACTIVITY DETECTION TASK TO CLASSIFY IMAGES TO 16 PREDEFINED LABELS.  
PLEASE NOTE: THERE ARE NO DATASETS HERE AS IT IS SENSITIVE INFORMATION, ALL DATA AND FILES THAT CAN BE SENSITIVE ARE REMOVED.
