...
#set the model learning rate for adam optimizer
learning_rate = 0.00001
optimizer = Adam(learning_rate=learning_rate)

#load the data
image_embedding=np.load('/Users/tysonpais/Documents/Projects/Lifelog-Activity-Detection/TempData/ImageEmbeddingVGG19.npy')
...
#define the neural network model with 13 output classes
model = Sequential()
...
# model evaluation to check for Precision, recall and f1-score
...
#plotting the training loss and validation to check foor overfitting
