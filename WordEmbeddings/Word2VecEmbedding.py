import numpy as np
import pandas as pd
word2vec_all_embeddings=np.load("/Users/tysonpais/PycharmProjects/Lifelog-Activity-Detection/TempData/encoded_visual_concepts_word2vec.npy")
...
encoding=dict(zip(visual_concepts[0],word2vec_all_embeddings))
print(encoding.keys())
...
np.save("WordEmbeddingsWord2Vec.npy",word_embed)
